\section{Ejercicio 1: Una nueva esperanza}
    ...
    Por último se arma el camino óptimo partiendo del nodo destino en el tercer nivel y se va agregando de donde venia y me muevo a él hasta llegar al nodo incial, esto tiene complejidad $O(N + N')$, donde $N' < N$, porque como mucho el camino tiene $N$ nodos más buscar el camino especial $N'$.
