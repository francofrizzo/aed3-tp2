\section{Ejercicio 3: El retorno del jedi}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Cantidad de filas ($N$) o de columnas ($M$), $c$ igual a $70$},
	...
	\begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={},
                    xlabel={Tamaño de entrada ($N$ con $N = M$)},
                    ylabel={Tiempo de ejecución (nanosegundos)},
                    scaled x ticks=false,
                    scaled y ticks=false,
                    enlargelimits=0.05,
	...
	puede acotar por una función cuadrática con constante $c = 15$.  \begin{figure}[H]
        \centering
        \caption{}
