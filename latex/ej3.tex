\section{Ejercicio 3: El retorno del jedi}
	...
	\begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/elRetornoDelJediFilasYColumnas1};
                \addplot[color=red] table[x index=0,y index=1]{../exp/elRetornoDelJediFilasYColumnas2};
                \addplot[color=blue] table[x index=0,y index=1]{../exp/elRetornoDelJediFilasYColumnas3};
                \addplot[color=violet] table[x index=0,y index=1]{../exp/elRetornoDelJediFilasYColumnas4};
                \addplot[color=green] table[x index=0,y index=1]{../exp/elRetornoDelJediFilasYColumnas5};
    ...
    Como se ve los picos bla bla bla ...
