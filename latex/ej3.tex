\section{Ejercicio 3: El retorno del jedi}
    ...
    En la Figura \ref{fig:exp3:var-nxn-base} se puede apreciar que para cada $N$
    los picos difieren entre las diferentes corridas. 
    Este análisis escapa al control de las variables que poseemos, ya que estos experimentos fueron corridos con 
    los mismos parámetros. Por lo cual se esperaba que los picos de dicho gráfico sean idénticos o muy parecidos entre sí. Entonces 
