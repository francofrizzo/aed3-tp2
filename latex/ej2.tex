\section{Ejercicio 2: El Imperio contraataca}
    ...
    \subsubsection{Modelo: descripción y prueba de correctitud}
    ...
    \subsubsection{Implementación: algoritmos y estructuras de datos
    utilizados}
    ...
    El algoritmo de Prim parte marcando un nodo inicial cualquiera del
    grafo. Luego, comienza a construir la solución, agregando el eje de menor
    peso que sea adyacente a dicho nodo, y marcando su otro extremo. Este
    proceso se repite, agregando en cada iteración la arista de menor peso que
    tenga por extremo un nodo marcado y otro sin marcar, y marcando este
    último, hasta que ya no queden nodos sin marcar.
    ...
    utilizando una cola de prioridad sobre heap binario.
