\section{Ejercicio 2: El Imperio contraataca}
    ...
    \renewcommand\constante{22000000}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=black] table[x index=0,y expr={\thisrowno{1} / x}]{../exp/elImperioContraatacaArboles};
                \addplot[color=red] table[x index=0, y expr={ln(x + 1)*\constante}]{../exp/elImperioContraatacaArboles};
