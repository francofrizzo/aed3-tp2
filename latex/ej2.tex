\section{Ejercicio 2: El Imperio contraataca}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    title={Cantidad de nodos fija $N = 300$},
                ...
                \addplot[color=black] table[x index=0,y index=1]{../exp/elImperioContraataca};
                \addplot[color=red] table[x index=0, y expr={x*\constante}]{../exp/elImperioContraataca};
                \legend{$T$, $c*M$}
            \end{axis}
        \end{tikzpicture}
    \end{figure}
